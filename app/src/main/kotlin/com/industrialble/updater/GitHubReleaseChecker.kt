 ...
 * Compara versiones semánticas (v1.0.0, v1.0.1, etc.) contra la versión actual de la app.
 */
class GitHubReleaseChecker(
    ...
    suspend fun checkForUpdate(currentVersion: String): ReleaseInfo? = withContext(Dispatchers.IO) {
        try {
            ...
            connection.apply {
                ...
                setRequestProperty("User-Agent", "HackDroid-Updater")
            }
    ...
    /** Compara dos versiones semánticas. Retorna >0 si v1 > v2 */
